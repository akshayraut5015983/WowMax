...
public class VdoDetailsOfflineActivity extends AppCompatActivity {
      ...
      /*  String imgUrl = Config.URL + imgCode;
        ...
        findViewById(R.id.tvTriler).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast toast = Toast.makeText(VdoDetailsOfflineActivity.this, "Coming Soon", Toast.LENGTH_SHORT);
        ...
        findViewById(R.id.imgShare).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nf != null && nf.isConnected() == true) {
                    ...
                    Toast.makeText(VdoDetailsOfflineActivity.this, "Check internet connection", Toast.LENGTH_SHORT).show();
                }
    ...
    protected void onStart() {
        ...
        findViewById(R.id.imgSetting).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PopupMenu popup = new PopupMenu(VdoDetailsOfflineActivity.this, view);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        Toast.makeText(VdoDetailsOfflineActivity.this, "Quality : " + item.getTitle(), Toast.LENGTH_SHORT).show();
                        return true;
        ...
        mVideoView.setOnCompletionListener(
                new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        Toast.makeText(VdoDetailsOfflineActivity.this,

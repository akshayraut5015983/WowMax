...
public class AdapterActionDrama extends RecyclerView.Adapter<AdapterActionDrama.ViewHolder> {
    private List<MainMovieListModel> android;
    private Context mContex;

    public AdapterActionDrama(List<MainMovieListModel> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterActionDrama.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(AdapterActionDrama.ViewHolder viewHolder, int i) {

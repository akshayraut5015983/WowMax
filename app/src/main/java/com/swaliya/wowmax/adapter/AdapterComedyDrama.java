...
public class AdapterComedyDrama extends RecyclerView.Adapter<AdapterComedyDrama.ViewHolder> {
    private List<MainMovieListModel> android;
    private Context mContex;

    public AdapterComedyDrama(List<MainMovieListModel> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterComedyDrama.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(AdapterComedyDrama.ViewHolder viewHolder, int i) {

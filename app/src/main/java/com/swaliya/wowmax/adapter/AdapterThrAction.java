...
public class AdapterThrAction extends RecyclerView.Adapter<AdapterThrAction.ViewHolder> {
    private List<MainMovieListModel> android;
    private Context mContex;

    public AdapterThrAction(List<MainMovieListModel> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterThrAction.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(AdapterThrAction.ViewHolder viewHolder, int i) {

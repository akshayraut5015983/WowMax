...
public class AdapterShortList extends RecyclerView.Adapter<AdapterShortList.ViewHolder> {
    private List<Slider10Model> android;
    private Context mContex;

    public AdapterShortList(List<Slider10Model> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterShortList.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rec_movie_short, viewGroup, false);
        return new ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(AdapterShortList.ViewHolder viewHolder, int i) {

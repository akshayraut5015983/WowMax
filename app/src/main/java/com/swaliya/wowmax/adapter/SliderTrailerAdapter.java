...
public class SliderTrailerAdapter extends PagerAdapter {
    Context mContext;
    List<Slider10Model> categoryArrayList;
    LayoutInflater mLayoutInflater;
    Button go;

    public SliderTrailerAdapter(Context m_Context, List<Slider10Model> categoryArrayList) {
...
//        View itemView = (View) mLayoutInflater.inflate(R.layout.item_service_banner, null);
        View itemView = mLayoutInflater.inflate(R.layout.item_banner_trailer, container, false);

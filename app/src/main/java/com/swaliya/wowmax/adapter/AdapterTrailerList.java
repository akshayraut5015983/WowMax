...
public class AdapterTrailerList extends RecyclerView.Adapter<AdapterTrailerList.ViewHolder> {
    private List<Slider10Model> android;
    private Context mContex;

    public AdapterTrailerList(List<Slider10Model> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterTrailerList.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rec_movie_triler, viewGroup, false);
        return new ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(AdapterTrailerList.ViewHolder viewHolder, int i) {

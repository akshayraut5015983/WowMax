...
public class AdapterRomance extends RecyclerView.Adapter<AdapterRomance.ViewHolder> {
    private List<MainMovieListModel> android;
    private Context mContex;

    public AdapterRomance(List<MainMovieListModel> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterRomance.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(AdapterRomance.ViewHolder viewHolder, int i) {

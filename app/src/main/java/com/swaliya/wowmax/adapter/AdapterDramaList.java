...
public class AdapterDramaList extends RecyclerView.Adapter<AdapterDramaList.ViewHolder> {
    private List<Slider10Model> android;
    private Context mContex;

    public AdapterDramaList(List<Slider10Model> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterDramaList.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rec_movie_drama, viewGroup, false);
        return new ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(AdapterDramaList.ViewHolder viewHolder, int i) {

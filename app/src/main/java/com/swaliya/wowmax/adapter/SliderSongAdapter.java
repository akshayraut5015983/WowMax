...
public class SliderSongAdapter extends PagerAdapter {
    Context mContext;
    List<Slider10Model> categoryArrayList;
    LayoutInflater mLayoutInflater;
    Button go;

    public SliderSongAdapter(Context m_Context, List<Slider10Model> categoryArrayList) {
...
//        View itemView = (View) mLayoutInflater.inflate(R.layout.item_service_banner, null);
        View itemView = mLayoutInflater.inflate(R.layout.item_banner_song, container, false);

...
public class AdapterRemAll extends RecyclerView.Adapter<AdapterRemAll.ViewHolder> {
    private List<MainMovieListModel> android;
    private Context mContex;

    public AdapterRemAll(List<MainMovieListModel> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterRemAll.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(AdapterRemAll.ViewHolder viewHolder, int i) {

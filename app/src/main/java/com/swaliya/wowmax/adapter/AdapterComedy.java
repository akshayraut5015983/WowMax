...
public class AdapterComedy extends RecyclerView.Adapter<AdapterComedy.ViewHolder> {
    ...
    public AdapterComedy(List<MainMovieListModel> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterComedy.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(AdapterComedy.ViewHolder viewHolder, int i) {

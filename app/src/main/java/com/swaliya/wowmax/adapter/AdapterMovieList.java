...
public class AdapterMovieList extends RecyclerView.Adapter<AdapterMovieList.ViewHolder> {
    ...
    public AdapterMovieList(List<Slider10Model> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterMovieList.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rec_movie, viewGroup, false);
        return new ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(AdapterMovieList.ViewHolder viewHolder, int i) {

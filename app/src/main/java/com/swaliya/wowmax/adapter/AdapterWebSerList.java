...
public class AdapterWebSerList extends RecyclerView.Adapter<AdapterWebSerList.ViewHolder> {
    private List<Slider10Model> android;
    private Context mContex;

    public AdapterWebSerList(List<Slider10Model> android, Context mContex) {
        this.android = android;
        this.mContex = mContex;
    }

    @Override
    public AdapterWebSerList.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rec_movie_web, viewGroup, false);
        return new ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(AdapterWebSerList.ViewHolder viewHolder, int i) {
